...
module.exports = {
    ...
    createFeed: (options) => {
        ...
        if (options.character) {
            app.options.path = encodeURI('/wow/character/' + options.realm.toLowerCase() + '/' + options.character);
            ...
            app.options.path = encodeURI('/wow/guild/' + options.realm.toLowerCase() + '/' + options.guild.replace(' ', '_'));
