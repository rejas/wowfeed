...
var app = {
    ...
    createCharFeed: function(data, success, error) {
        var feed = new RSS({
                ...
                link: 'http://' + app.options.host + app.options.path,
                image: 'http://' + app.options.host + '/static-render/' + app.options.region + '/' + data.thumbnail,
    ...
    createCharItem: function(item) {
        ...
        rss.date = new Date(item.timestamp);
