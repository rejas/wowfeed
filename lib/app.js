...
module.exports = {
    ...
    createFeed: function(options, success, callError) {
        app.options = options;
        ...
        if (options.character) {
            ...
            blizzard.wow.character(['feed'], {
                ...
                .then((response) => {
                    return app.createCharFeed(response.data, success, error);
                })
                .catch((error) => {
                    callError(error);
                });
            ...
            blizzard.wow.guild(['news'], {
                ...
                .then((response) => {
                    return app.createGuildFeed(response.data, success, error);
                })
                .catch((error) => {
                    callError(error);
                });
